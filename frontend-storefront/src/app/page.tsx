      ...
      <main className="mx-auto max-w-[1600px] px-4 py-6">
        ...
        <div className="mt-8">
          <div className="mb-5 flex items-center justify-between">
            <div>
              <h2 className="text-xl font-extrabold text-gray-900 sm:text-2xl">Tất Cả Sản Phẩm</h2>
              <p className="mt-1 text-sm text-gray-500">{total} sản phẩm đang có mặt</p>
            </div>
          </div>
            ...
            <section className="min-w-0 flex-1">
              ...
              {products.length === 0 && (
                <div className="mt-4 rounded-md border border-dashed border-gray-300 bg-white p-8 text-center text-sm text-gray-500">
                  Không tìm thấy sản phẩm nào. Hãy chạy backend và seed database để tải sản phẩm.
                </div>
              )}
